...
public class ChatController {
    ...
    @FXML
    private ImageView sendImageButtonImageView, applyChatButton, cancelChatButton, sendButtonImageView, closeWindowButton, minimizeWindowButton;
    @FXML
    ...
    private void setActionsOnObjects() {
        try {
            ...
            sendImageButtonImageView.setOnMouseClicked(mouseEvent -> {
